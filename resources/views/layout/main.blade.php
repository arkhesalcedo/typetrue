...
<head>
    ...
    <script>
        ...
        fbq('init', '225450125710329');
        fbq('track', 'PageView');
    </script>
    <noscript>
        <img alt="facebook pixel" height="1" width="1" src="https://www.facebook.com/tr?id=225450125710329&ev=PageView&noscript=1"/>
    </noscript>
    ...
    <meta name="facebook-domain-verification" content="nbbjycwfc1whlqvkwgdst4oqcydawx" />
</head>

<body>
    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-529ZJD6";
            ...
            <div class="tw-container tw-mx-auto tw-px-4">
                ...
                <div class="tw-flex tw-justify-between tw-flex-col md:tw-flex-row tw-items-center">
                    <div class="tw-flex tw-flex-wrap sm:tw-flex-no-wrap tw--mx-2 tw-mb-5 md:tw-mb-0">
                        ...
                        <div class="tw-text-center tw-mb-5 sm:tw-mb-0 sm:tw-mx-2 tw-w-1/2 sm:tw-w-auto">
                            <a href="https://zoomerradio.ca/" target="_blank">
